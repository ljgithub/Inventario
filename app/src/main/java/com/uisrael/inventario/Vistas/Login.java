package com.uisrael.inventario.Vistas;
...
import com.uisrael.inventario.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(txt_user.getText().toString().equals("javi") && txt_pass.getText().toString().equals("uisrael.2019")){
                    Intent intent = new Intent(view.getContext(), Proveedor.class);
